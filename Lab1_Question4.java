...
//		deerPlay(95, true); - > true
	...
	public static void deerPlay(int temp, boolean isSummer) {
		...
		if (isSummer) {
			if (temp > 60 && temp < 100) {
				System.out.println("Its summer, play between temperature 60-100");
				System.out.println(true);
			} else {
				System.out.println("Its summer, but they dont play because of temp");
				System.out.println(false);
			}
		} else {
			if (temp > 60 && temp < 90) {
				System.out.println("Its not summer, but play between temperature 60-90");
				System.out.println(true);
			} else {
				System.out.println("Its not summer, but they dont play because of temp");
				System.out.println(false);
			}
		}
	}
